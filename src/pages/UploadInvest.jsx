        ...
        if (validUpload(values).valid) {
            if(image) {
                try {
                    ...
                    setUploading(true)
                    const storageImageRef = ref(storage, `invests/${values.title}/`+values.title)
                    ...
                    // save in db
                    axios.post(`${API_URL}/upload-invest`, values)
                    .then(res => {
                        console.log(res)
                    })
                    .catch(err => {
    ...
    return (
        <div className=" flex justify-center items-center">
            ...
            <div className=" font-cairo flex flex-col justify-center gap-4 items-center">
                <h2 className=" text-2xl font-bold ">رفع تحقيق جديد</h2>
                ...
                <div className="flex justify-around items-center gap-5 flex-col p-5 mx-auto">
                    <div className="flex flex-col font-cairo w-full justify-center gap-4 mx-auto">
                        <label className="text-end"   htmlFor="">عنوان التحقيق</label>
                    ...
                    <div className="flex flex-col font-cairo w-full justify-center gap-4 mx-auto">
                        <label  className="text-end"  htmlFor="">رفع التحقيق </label>
